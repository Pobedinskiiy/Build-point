 ...
 */
 ...
 class SliderNews {
  ...
  static PREFIX = 'slider-news';
  static EL_WRAPPER = `${SliderNews.PREFIX}-container`;
  static EL_ITEM = `${SliderNews.PREFIX}-item`;
  static EL_ITEM_ACTIVE = `${SliderNews.PREFIX}__item_active`;
  static EL_ITEMS = `${SliderNews.PREFIX}-items`;
  static EL_INDICATOR = `${SliderNews.PREFIX}-indicator`;
  static EL_INDICATOR_ACTIVE = `${SliderNews.PREFIX}__indicator_active`;
  static EL_INDICATORS = `${SliderNews.PREFIX}__indicators`;
  static EL_CONTROL = `${SliderNews.PREFIX}-btn`;
