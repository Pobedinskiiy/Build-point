 ...
 */
 ...
 class SliderMain {
  ...
  static PREFIX = 'slider-main';
  static EL_WRAPPER = `${SliderMain.PREFIX}-container`;
  static EL_ITEM = `${SliderMain.PREFIX}-item`;
  static EL_ITEM_ACTIVE = `${SliderMain.PREFIX}-item-active`;
  static EL_ITEMS = `${SliderMain.PREFIX}-items`;
  static EL_INDICATOR = `${SliderMain.PREFIX}-indicator`;
  static EL_INDICATOR_ACTIVE = `${SliderMain.PREFIX}-indicator-active`;
  static EL_INDICATORS = `${SliderMain.PREFIX}-indicators`;
  static EL_CONTROL = `${SliderMain.PREFIX}-btn`;
